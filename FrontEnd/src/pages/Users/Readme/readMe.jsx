...
import { teamsData } from './readmeData';
import './readMe.css';
      ...
      <main className="readme-main">
        ...
        <section id="terms" className="readme-section">
          ...
          <p className="readme-text">
            Welcome to the centralized Employee Management System (EMS) for Asia Softlab Pvt. Ltd. This platform is strictly for authorized personnel only. 
          </p>
        ...
        <section id="leaves" className="readme-section">
          ...
          <ol className="readme-list">
            <li>1. Navigate to the <strong>Leaves</strong> tab in the sidebar.</li>
            <li>2. Click on the <strong>Apply Leave</strong> button.</li>
            <li>3. Select the Leave Type (Casual, Sick, or Emergency).</li>
            <li>4. Provide a valid <strong>Reason</strong> and select your date ranges.</li>
            <li>5. <strong>Submit.</strong> Your manager will be notified instantly.</li>
          </ol>
        ...
        <section id="wfh" className="readme-section">
          ...
          <p className="readme-text">
            We support hybrid working models. Employees are eligible for up to 1 WFH day (may be Saturday), subject to manager approval and project requirements.
          </p>
          <ul className="readme-list">
        ...
        <footer className="readme-footer" style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "10px" }}>
          <h3 className="readme-footer-text" style={{ textAlign: "center" }}>
             <Code size={16} color="#94a3b8" /> If any important Queries and suggestions, kindly contact the Software & Development Team.
          </h3>
          <h3 style={{textAlign: "center", color: "#94a3b8"}}>Thank you</h3>
        </footer>
